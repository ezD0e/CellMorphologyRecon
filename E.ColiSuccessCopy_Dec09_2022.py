...
#Open image with traditional way
img = Image.open("Z:/CodeCluster/DingPic2022Dec/cell membrane contour.png")
mask_labels = label(np.asarray(img))

#Define interested region properties 
